...
## Project Structure
    ...
    ├── testapiautocatalog_124272  # Django project configurations
...
1. Clone this repo and `cd testapiautocatalog_124272`
...
2. Clone this repo and `cd testapiautocatalog_124272`
